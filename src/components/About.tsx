    ...
    return (
        <section className="py-24 md:py-32 px-6 md:px-12 relative z-20 border-t border-gray-200 dark:border-white/5">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <h2 className="text-sm font-semibold tracking-widest text-[#6b7280] dark:text-[#a1a1aa] uppercase mb-8">
                        About Me
                    </h2>
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-[#4a4a5a] dark:text-gray-400 max-w-3xl leading-relaxed">
