...
export default function Projects() {
    ...
    return (
        <section className="min-h-screen py-24 md:py-32 px-6 md:px-12 relative z-20 border-t border-white/5">
            <div className="max-w-5xl mx-auto">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-12 sm:mb-16 text-white">Selected Work</h2>
